...
const Meal = require('./methods/meal');
...
async function compose() {
      ...
      Vision,
      {
        ...
        options: {
          ...
          tags: [
            {
              name: 'auth',
              description: 'Authorization process API',
            },
            {
              name: 'auth-token',
            ...
            {
              name: 'food-component',
              description: 'Food components (proteins, fats etc) API',
            },
            {
              name: 'user',
            ...
            {
              name: 'weight',
              description: 'Weight control API',
            },
          ],
          grouping: 'tags',
        },
  ...
  server.method('meal.transformForResponse', Meal.transformForResponse);
  ...
  server.schwifty(require('./db/models/meal'));
  server.schwifty(require('./db/models/mealProduct'));
  ...
  // meals routes
  server.route(require('./routes/food-tracker/meals/create'));
  server.route(require('./routes/food-tracker/meals/delete'));
  server.route(require('./routes/food-tracker/meals/details'));
  server.route(require('./routes/food-tracker/meals/listing'));
  server.route(require('./routes/food-tracker/meals/update'));
  server.route(require('./routes/food-tracker/meals/product/create'));
  server.route(require('./routes/food-tracker/meals/product/delete'));
  server.route(require('./routes/food-tracker/meals/product/update'));
